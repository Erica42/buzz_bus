function setBlueDot(setMap){
 ...
 function setDestinationMarker(setMap){
  var map = setMap;
  var location = new google.maps.Marker({ clickable: false,icon: new google.maps.MarkerImage('https://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|FE7569'),
      map: map
  });
   return location;
 }
